			...
			<view class="popup-body">
				<scroll-view scroll-y="true" show-scrollbar="true" style="height: 390rpx;">
					<view class="updateBox">
						<view v-if="isEditing">
							<updateImage @uploadPic="uploadPic" @uploadStatusChange="handleUploadStatusChange"
								:delFlag="false" :imageObj="localGoods.goods_pic"></updateImage>
						</view>
						<view v-else-if="goods.goods_pic?.imgUrl">
							<image :style="{height:'180rpx', width:'180rpx'}" :src="goods.goods_pic.imgUrl"
								class="goods-img" @click="previewImage(goods.goods_pic.imgUrl)" mode="aspectFill" />
						</view>
					</view>
